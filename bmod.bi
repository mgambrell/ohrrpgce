...
DECLARE SUB anim_setmove(who as integer, xstep as integer, ystep as integer, ticks as integer)
...
DECLARE SUB anim_zmove(byval who as integer, byval zstep as integer, byval zticks as integer)
